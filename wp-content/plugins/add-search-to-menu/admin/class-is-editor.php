    ...
    public function includes_panel( $post )
    {
        ...
        foreach ( $post_types as $post_type ) {
            ...
            if ( !empty($posts) ) {
                ...
                $html .= $col_title . '<input class="list-search" placeholder="' . __( "Buscar", 'ivory-search' ) . '" type="text"></div>';
            ...
            if ( !empty($tax_objs) ) {
                ...
                foreach ( $tax_objs as $key => $tax_obj ) {
                    ...
                    if ( !empty($terms) ) {
                        ...
                        $html .= $col_title . '<input class="list-search" placeholder="' . __( "Buscar", 'ivory-search' ) . '" type="text"></div><input type="hidden" id="' . $id . '-tax_post_type" name="' . $id . '[tax_post_type][' . $key . ']" value="' . implode( ',', $tax_obj->object_type ) . '" />';
            ...
            if ( !empty($meta_keys) ) {
                ...
                $selected_meta = false;
                $html .= '<input class="list-search wide" placeholder="' . __( "Buscar", 'ivory-search' ) . '" type="text">';
            ...
            if ( !empty($tax_objs) ) {
                ...
                foreach ( $tax_objs as $key => $tax_obj ) {
                    ...
                    if ( !empty($terms) ) {
                        ...
                        $html .= $col_title . '<input class="list-search" placeholder="' . __( "Buscar", 'ivory-search' ) . '" type="text"></div><select class="_is_excludes-tax_query" name="' . $id . '[tax_query][' . $key . '][]" multiple size="8" >';
                        foreach ( $terms as $key2 => $term ) {
